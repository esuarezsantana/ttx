function [fsize] = rawfieldsize (Tf)
%TENSOR/RAWFIELDSIZE Size of the field of the tensor field.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%   This file comes with the ttx tensor toolbox
%
%   Module: @tensor/rawfieldsize.m
%
...
% this method is necessary to inherite new classes

dsize = Tf.datasize;
if (isempty(Tf.dimension))
  fsize = 0;
elseif (Tf.dimension(1) == 0)
  fsize = 1;
else
  fsize = dsize(1:Tf.dimension(1));
end
