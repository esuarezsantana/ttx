function [e] = eighelper(varargin)
%EIGHELPER Helper function for eig method.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%   This file comes with the ttx tensor toolbox
%
%   Module: @tensor/private/eighelper.m
%
...
error(['A compiled version of eighelper does not seem ' ...
  'to be available on this platform.']);
